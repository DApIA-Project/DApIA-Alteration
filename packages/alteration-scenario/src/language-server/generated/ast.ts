...
export interface AlterationscenarioAstType {
...
export class AlterationscenarioAstReflection extends AbstractAstReflection {
  getAllTypes(): string[] {
    return [
      'ASTAllPlanes',
      'ASTAlter',
...
export const reflection = new AlterationscenarioAstReflection()
