...
const IAlterationContractTest: IContractTest = (
  ...
  describe(implementationName, () => {
    ...
    it('valid declaration variable', async () => {
      ...
      assert.deepStrictEqual(
        round(parse(recordingsAltered[0].content)),
        round(parse('MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:17.758,2018/11/25,12:22:18.758,,30000,,,48.2206,3.557,,,0,0,0,0\n' +
      ...
      assert.deepStrictEqual(
        ...
        round(parse('MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:16.800,2018/11/25,12:22:20.800,,30000,,,48.2206,3.557,,,0,0,0,0\n' +
          '\n'))
      )
    })
  })
