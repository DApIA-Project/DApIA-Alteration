...
function round_message(msg: Message): Message {
  ...
  let round_to = (n?: number, p?: number) =>
    n ? parseFloat(n.toPrecision(p)) : n
  ...
  describe(implementationName, () => {
    ...
    it('valid alter trajectory at', async () => {
      ...
      assert.deepStrictEqual(
        ...
        round(
          parse(
            'MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:16.239,2018/11/25,12:22:16.239,,9000,1341.036323355846,75.34033242853468,48.22040,3.55600,0,,0,0,0,0\n' +
    ...
    it('valid replay', async () => {
      let recordingsAltered: Recording[] =
        await alterationManager.runAlterations(
          ...
          { name: 'testReplay.sbs', content: contentReplay }
				...
				fs.writeFileSync("/tmp/replay.sbs", recordingsAltered[0].content);
      assert.deepStrictEqual(
        recordingsAltered[0].name,
        'modified__zigzag2_0.sbs'
      )
      ...
      assert.deepStrictEqual(
        round(parse(recordingsAltered[0].content)),
				round(
					parse(
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:16.239,2018/11/25,12:22:16.239,,30000,,,48.22060,3.55700,,,0,0,0,0\n"+
						...
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:16.842,2018/11/25,12:22:16.842,,30000,,,48.22190,3.55620,,,0,0,0,0\n"+
						...
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:18.758,2018/11/25,12:22:18.758,,30000,,,48.22600,3.55340,,,0,0,0,0\n"+
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.221,2018/11/25,12:22:19.221,,29975,,,48.22710,3.55270,,,0,0,0,0\n"+
						"MSG,1,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.501,2018/11/25,12:22:19.501,AZA676,,,,,,,,,,,\n"+
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.695,2018/11/25,12:22:19.695,,29975,,,48.22710,3.55270,,,0,0,0,0\n"+
						"MSG,4,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.843,2018/11/25,12:22:19.843,,,517.63,336.31,,,0,,,,,\n"+
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:20.171,2018/11/25,12:22:20.171,,30000,,,48.22930,3.55130,,,0,0,0,0\n"+
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:20.179,2018/11/25,12:22:20.179,,30000,,,48.22800,3.55220,,,0,0,0,0\n"+
						"MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:20.800,2018/11/25,12:22:20.800,,30000,,,48.23060,3.55050,,,0,0,0,0\n"
					)
				)
			)
    ...
    it('valid declaration variable', async () => {
      ...
      assert.deepStrictEqual(
        ...
        round(
          parse(
            'MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:17.758,2018/11/25,12:22:18.758,,30000,,,48.22190,3.55620,,,0,0,0,0\n' +
      ...
      assert.deepStrictEqual(
        ...
        round(
          parse(
            'MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:16.800,2018/11/25,12:22:20.800,,30000,,,48.2219,3.5562,,,0,0,0,0\n' +
              '\n'
          )
        )
      )
