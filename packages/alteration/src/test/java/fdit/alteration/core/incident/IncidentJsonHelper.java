...
public class IncidentJsonHelper {
    ...
    public static Predicate<IncidentJson> anIncident(final Predicate<IncidentJson> predicate) {
        return incident -> {
    ...
    @SafeVarargs
    public static Predicate<IncidentJson> withSensors(final Predicate<Sensor>... sensors) {
        return incident -> {
