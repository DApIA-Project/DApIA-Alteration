...
public class AltitudeReplyData extends BeastData {
    ...
    public AltitudeReplyData(final int downlink_format,
    ...
    public AltitudeReplyData copy() {
        return new AltitudeReplyData(
                getDownlink_format(),
                getFirst_field(),
                getIcao24(),
                getPayload(),
