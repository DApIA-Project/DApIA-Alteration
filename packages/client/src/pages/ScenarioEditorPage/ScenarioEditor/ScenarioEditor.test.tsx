...
jest.mock(
    '../CodeArea/MonacoEditor',
    () => () => <div className={'view-lines monaco-mouse-cursor-text'}
                     role={"code"}>hide all_planes at 0 seconds</div>
)
...
describe('ScenarioEditor', () => {
    ...
    it('calls onGenerate callback if generate button is clicked with scenario content', async () => {
        ...
        const generateButton = await screen.findByTestId(ScenarioEditorTestIds.GENERATE_BUTTON)
