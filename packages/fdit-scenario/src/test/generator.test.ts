...
describe("generatorTestMocha", () => {
    ...
    context('when scenario is valid', () => {
        ...
        it('returns json with action when content is with declaration and alter with_values constant ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("let $test = [2,8], alter all_planes from 13 seconds until 88 seconds with_values ALTITUDE = $test", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is replay all_planes from until REC_DURATION ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("replay all_planes from_recording 56.8 * REC_DURATION from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is replay all_planes from until REC_NBR_AIRCRAFT ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("replay all_planes from_recording 56.8 * REC_NBR_AIRCRAFT from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is replay all_planes from until ALT_DURATION ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("replay all_planes from_recording 56.8 * ALT_DURATION from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is replay all_planes from until double ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("replay all_planes from_recording 56.8 from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is hide planes from until', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("hide plane satisfying \"TESTES\" from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
        ...
        it('returns json with action when content is replay planes from until ', async () => {
            const scenario = extractAstNodeFromString<ASTScenario>("replay planes satisfying \"TESTE\" from_recording \"34.sbs\" from 56 seconds until 90 seconds", services!);
            assert.deepStrictEqual(generateCommands(await scenario,"zigzag.sbs",fileContent),
                {
                    "sensors": {
                        "sensor": [
