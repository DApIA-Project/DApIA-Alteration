...
describe('Message parser', () => {
  ...
  it('should stringify a message', () => {
    let src =
      'MSG,0,3,10610299,A1E67B,10610299,2019/04/19,17:30:00.140,2019/04/19,17:30:00.140,,16625,,,50.40730,8.24640,,,0,0,0,0'
    let msg = parse(src)[0]
  ...
  it('should parse a valid Message lower case hexIdent', () => {
    const msgs = parse(
      'MSG,3,3,5022202,39ac45,5022202,2022/07/01,05:08:57.000000,2022/07/01,05:08:57.000000,SAMUCF,550.0,66.0,303.20657031508955,43.61418643240201,1.3985988071986606,192.0,7015,0,0,0,0'
    )
    expect(msgs[0]).to.include({
      hexIdent: '39ac45',
    })
