...
describe("Message parser", () => {
    it("should return null if the hexIdent is not valid", () => {
        let msg = (0, src_1.parse)("MSG,0,3,10610299_MISSING_ICAO_10610299,2019/04/19,17:30:00.140,2019/04/19,17:30:00.140,,16625.0,,,50.4073,8.2464,,,0,0,0,0");
        (0, chai_1.expect)(msg).not.to.be.empty;
    });
    it("should parse a valid Message", () => {
        let msg = (0, src_1.parse)("MSG,0,3,10610299,A1E67B,10610299,2019/04/19,17:30:00.140,2019/04/19,17:30:00.140,,16625.0,,,50.4073,8.2464,,,0,0,0,0");
        (0, chai_1.expect)(msg[0]).to.include({
            hexIdent: "A1E67B",
    ...
    it("should parse several message", () => {
        let msgs = (0, src_1.parse)("MSG,0,30,1105,300065,3839,2018/02/28,16:04:30.987,2018/02/28,16:04:31.888,,,414.1,333,,,64,,,,,\n" +
        ...
        (0, chai_1.expect)(msgs).to.have.lengthOf(11);
    });
});
