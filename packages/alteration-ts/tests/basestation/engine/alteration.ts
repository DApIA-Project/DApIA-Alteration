...
describe('Alteration engine', () => {
  it('should replace altitude', () => {
    ...
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.200,2019/04/19,17:29:45.200,BAW256,203050,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
    ...
    const actual = alteration({
      scope: target('4B1613'),
      modifications: [
        { property: 'altitude', value: 12000, mode: AlterationMode.REPLACE },
      ],
    }).processing([msg])
  ...
  it('should replace latitude with time window', () => {
    ...
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.200,2019/04/19,17:29:45.200,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
  ...
  it('sould replace latitude with time window and extra field', () => {
    const start_date = 1555694985200
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.200,2019/04/19,17:29:45.200,BAW256,20350,442.2,358.1,123.1,8.4823,0,4022,0,0,0,0,{"baroaltitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
    )[0]
  ...
  it('should replace icao with lower time limit', () => {
    ...
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:55.000,2019/04/19,17:29:55.000,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
    ...
    const actual = alteration({
      scope: and(
        target('4B1613'),
        timeWindow(msg.timestampGenerated, msg.timestampGenerated + 10000)
      ),
      property: 'hexIdent',
      value: '39AC45',
      mode: AlterationMode.REPLACE,
  ...
  it('should replace latitude and longitude', () => {
    const start_date = 1555694985000
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:30:00.000,2019/04/19,17:30:00.000,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
  ...
  it('should replace with a false alert with upper time limit', () => {
    const start_date = 1555694985000
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.020,2019/04/19,17:29:45.020,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
  ...
  it('should replace callsign with lower time limit', () => {
    const start_date = 1555694985000
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.030,2019/04/19,17:29:45.030,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
  ...
  it('should add offset to groundspeed', () => {
    const start_date = 1555694985000
    const msg = parse(
      'MSG,0,0,0,4B1613,0,2019/04/19,17:29:45.035,2019/04/19,17:29:45.035,BAW256,20350,442.2,358.1,49.6684,8.4823,0,4022,0,0,0,0'
    )[0]
