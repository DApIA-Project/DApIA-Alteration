...
describe('Aircraft Trajectory Builder', () => {
  it("should create an interpolation that's pass throught waypoint", () => {
    let trajectory = new AircraftBuilder()
      .add_point({
        timestampGenerated: 1000,
        latitude: 1.0,
        longitude: 9.5,
        altitude: 15000,
      })
      .add_point({
        timestampGenerated: 2000,
        latitude: 1.1,
        longitude: 9.6,
        altitude: 15025,
      })
      .add_point({
        timestampGenerated: 3000,
        latitude: 1.2,
        longitude: 9.7,
        altitude: 15050,
      })
      .add_point({
        timestampGenerated: 4000,
        latitude: 1.3,
        longitude: 9.8,
        altitude: 15075,
      })
      .add_point({
        timestampGenerated: 5000,
        latitude: 1.4,
        longitude: 9.9,
        altitude: 15100,
      })
  ...
  it('should return track', () => {
    let trajectory = new AircraftBuilder()
      ...
      .add_point({
        timestampGenerated: 6000,
        latitude: 1.0,
        longitude: 2.0,
        altitude: 10000,
      })
      .add_point({
        timestampGenerated: 7000,
        latitude: 0.0,
        longitude: 2.0,
        altitude: 10000,
      })
      .add_point({
        timestampGenerated: 8000,
        latitude: 0.0,
        longitude: 1.0,
        altitude: 10000,
      })
      .add_point({
        timestampGenerated: 9000,
        latitude: 0.0,
        longitude: 0.0,
        altitude: 10000,
      })
  ...
  it('should return verticalRate', () => {
    let trajectory = new AircraftBuilder()
      .add_point({
        timestampGenerated: 0,
        latitude: 0.0,
        longitude: 0.0,
        altitude: 10000,
      })
      .add_point({
        timestampGenerated: 10000,
        latitude: 1.0,
        longitude: 0.0,
        altitude: 11000,
      })
      .add_point({
        timestampGenerated: 11000,
        latitude: 1.0,
        longitude: 0.0,
        altitude: 10900,
      })
      .add_point({
        timestampGenerated: 20000,
        latitude: 2.0,
        longitude: 0.0,
        altitude: 10000,
      })
      .add_point({
        timestampGenerated: 30000,
        latitude: 2.0,
        longitude: 1.0,
        altitude: 10500,
      })
      .add_point({
        timestampGenerated: 40000,
        latitude: 2.0,
        longitude: 2.0,
        altitude: 10000,
      })
 ...
 */
  ...
  it('not strictly increasing values', () => {
    let trajectory = new AircraftBuilder()
      ...
      .add_point({
        timestampGenerated: 1,
        latitude: 0,
        longitude: 0,
        altitude: 0,
      })
      .add_point({
        timestampGenerated: 2,
        latitude: 0,
        longitude: 0,
        altitude: 0,
      })
      .add_point({
        timestampGenerated: 3,
        latitude: 0,
        longitude: 0,
        altitude: 0,
      })
      .add_point({
        timestampGenerated: 4,
        latitude: 0,
        longitude: 0,
        altitude: 0,
      })
