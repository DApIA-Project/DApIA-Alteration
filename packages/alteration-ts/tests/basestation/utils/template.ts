...
describe("Template Messages", () => {
	it("shouldn't replace undefined values", () => {
		let msg = parse('MSG,1,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.501,2018/11/25,12:22:19.501,AZA676,,,,,,,,,,,\n')[0];
	...
	it("should replace defined values", () => {
		let msg = parse('MSG,3,3,5022202,4CA1FA,5022202,2018/11/25,12:22:19.221,2018/11/25,12:22:19.221,,29975.0,,,48.2271,3.5527,,,0,0,0,0\n')[0];
		let values = { latitude: 7, longitude: 9 };
